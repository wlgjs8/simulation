...
남은 차이는 명시적으로 관리합니다. 현재 카메라 fx≈335.96px와 최근 수집 데이터의
fx≈393px가 다르며, 패드/박스 pose와 PhysX drive·접촉 물성도 완전 실측 상태는 아닙니다.
공통 제어 알고리즘의 일치가 카메라·그리퍼 모터·접촉의 Real 동등성을 보장하지 않습니다.
